			...
			<div class="contenedor">
				...
				<article class="detalle">
					<div class="txt">
						...
						<p>Para ello realizamos un llamativo sitio web con navegación "one page", que ofrece la posibilidad de realizar pedidos online, ver noticias y promociones, listado de productos y precios.</p>

						<h5>Tecnologías:</h5>
						<p>HTML5, PHP y Jquery.</p>
					...
					<div class="ch-carousel mask">
						<ul>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/posta/02.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/posta/screen01.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/posta/screen02.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/posta/screen03.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/posta/screen04.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/posta/screen05.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/posta/screen06.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/posta/screen07.png" width="660" height="467" /></li>
						</ul>
					</div>
