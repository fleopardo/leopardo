			...
			<div class="contenedor">
				...
				<article class="detalle">
					<div class="txt">
						<h4>Later</h4>
						<h5>Resumen:</h5>
						<p>Later-Cer y Ceramica Quilmes, son empresas lideres en el mercado de ladrillos en Argentina.</p>
					...
					<div class="ch-carousel mask">
						<ul>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/later/01.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/later/02.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/later/screen01.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/later/screen02.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/later/screen03.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/later/screen04.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/later/screen05.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/later/screen06.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/later/screen07.png" width="660" height="467" /></li>
						</ul>
					</div>
