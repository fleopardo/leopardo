			...
			<div class="contenedor">
				...
				<article class="detalle">
					<div class="txt">
						<h4>Crac Agence</h4>
						<h5>Resumen:</h5>
						<p>Estuvimos a cargo del frontend del sitio agencecrac.com. El trabajo fue nomidado en cssdesignawards.com y ganador del "website del día" en cssawards.net</p>

						<p>Fuimos los encargados del maquetado y programado de su sitio web institucional.</p>

						<h5>Tecnologías:</h5>
						<p>HTML5, CSS y Javascript/Jquery.</p>
					...
					<div class="ch-carousel mask">
						<ul>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/crac-agence/01.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/crac-agence/screen01.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/crac-agence/screen02.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/crac-agence/screen03.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/crac-agence/screen04.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/crac-agence/screen05.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/crac-agence/screen06.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/crac-agence/screen07.png" width="660" height="467" /></li>
						</ul>
					</div>
