			...
			<div class="contenedor">
				...
				<article class="detalle">
					<div class="txt">
						<h4>Morico</h4>
						<h5>Resumen:</h5>
						<p>Estuvimos trabajando en la realización del sitio web Morico, una empresa que está en el mercado hace 10 años pero sin una identidad marcada.</p>

						<h5>Tecnologías:</h5>
						<p>HTML5, CSS, Javascript/Jquery y PHP.</p>
					...
					<div class="ch-carousel mask">
						<ul>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/morico/01.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/morico/screen01.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/morico/screen02.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/morico/screen03.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/morico/screen04.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/morico/screen05.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/morico/screen06.png" width="660" height="467" /></li>
						</ul>
					</div>
