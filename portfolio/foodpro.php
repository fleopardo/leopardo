			...
			<div class="contenedor">
				...
				<article class="detalle">
					<div class="txt">
						<h4>Foodpro</h4>
						<h5>Resumen:</h5>
						<p>La empresa llegó al mercado argentino para revolucionar la industría de los suplementos deportivos de alto rendimiento. Desarrollan productos innovadores y de alta gama.</p>

						<p>Estuvimos a cargo del desarrollo de su sitio web e integración las con redes sociales.</p>
					...
					<div class="ch-carousel mask">
						<ul>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/foodpro/01.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/foodpro/screen01.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/foodpro/screen02.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/foodpro/screen03.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/foodpro/screen04.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/foodpro/screen05.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/foodpro/screen06.png" width="660" height="467" /></li>
						</ul>
					</div>
