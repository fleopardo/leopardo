			...
			<div class="contenedor">
				...
				<article class="detalle">
					<div class="txt">
						<h4>Calpsa</h4>
						<h5>Resumen:</h5>
						<p>La empresa, que brinda productos y servicios para la industria del transporte en general, necesitaba una renovación en su imagen empresarial.</p>

						<p>Realizamos mejoras en el logo y creamos un nuevo sitio web con un administrador de productos adaptado a sus necesidades.</p>
					...
					<div class="ch-carousel mask">
						<ul>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/calpsa/02.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/calpsa/screen01.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/calpsa/screen02.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/calpsa/screen03.png" width="660" height="467" /></li>
							<li><img src="<?=$BASE_URL;?>/img/portfolio/calpsa/screen04.png" width="660" height="467" /></li>
						</ul>
					</div>
