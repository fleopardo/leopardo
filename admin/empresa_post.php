...
<body>
	...
	if( $result['empresa'] == ""){
		//hago el insert
		$Sql = "insert into institucionals (empresa,resumen) values ('$empresa','$resumen')";
		...
		//hago el update
		$Sql = "update institucionals set empresa='$empresa', resumen='$resumen'";
		mysql_query($Sql,$link);
		if (mysql_errno()){
			$error = true;
		}
