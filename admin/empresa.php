...
<body id="empresa">
	...
	<section>
		<h2>La empresa</h2>
		<form method="post" action="./empresa_post.php">
			<h3>Texto Empresarial</h3>
			<textarea name="empresa"><?=$result['empresa'];?></textarea>
			<h3>Resumen del Texto Empresarial</h3>
			<textarea name="resumen"><?=$result['resumen'];?></textarea>
			<input type="submit" value="enviar" />
		</form>
	</section>
	
	<footer>
		<p>Administrador de contenidos de <a href="http://www.calpsa.com.ar" rel="external" title="Ir a la pagina">Calpsa.com.ar</a> - <a href="./logout.php">[Cerrar Sesion]</a></p>
	</footer>
