...
<body id="empresa">
	...
	<section style="overflow: hidden;">
		...
		<div class="columnaDerecha">
			...
			<form action="./productos_post.php" enctype='multipart/form-data' method="post">
				<fieldset>
					
					<p><label for="nombre">Nombre:</label> <input type="text" id="nombre" name="nombre" class="text" value="<?= $_GET['nombre']; ?>" /></p>
					
					<p><label for="descripcion">Descripcion:</label><br />
					<textarea id="descripcion" name="descripcion"><?= $_GET['descripcion']; ?></textarea></p>
					...
					<select id="categoria" name="categoria">
						...
						?>
							<option value="<?= $resultCategs['id']?>"><?= $resultCategs["nombre"]?></option>
						<?php
							}
						?>
					</select>
